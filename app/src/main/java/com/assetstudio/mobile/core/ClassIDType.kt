...
/** Unity Class ID 参考: https://docs.unity3d.com/Manual/ClassIDReference.html */

enum class ClassIDType(val value: Int) {
    UnknownType(-1),
    Object(0),
    GameObject(1),
    Component(2),
    ...
    companion object {
        ...
        fun fromValue(value: Int): ClassIDType = map[value] ?: UnknownType
    }
}